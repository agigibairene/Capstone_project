      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <div className={`flex-1 flex flex-col overflow-hidden transition-all duration-300 ${
          ...
          <div className="flex flex-col flex-1 overflow-hidden pt-16 lg:pt-0">
           ...
           {activeItem !== "Your Profile" && activeItem !== "Create Project" && activeItem !== 'ChatBot' && (<header className="hidden lg:block  top-0 left-0 right-0 z-30 rounded-lg backdrop-blur-lg border-b border-white/30 p-3 pl-28 sm:p-4 md:p-6 mx-2 mt-2"
