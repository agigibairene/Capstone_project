...
export default function BotForm({
  ...
  return (
    <div className="flex items-center bg-white/20 backdrop-blur-sm border-r border-white/30 rounded-lg focus-within:ring-2 focus-within:ring-teal-500 focus-within:border-transparent shadow-sm">
      <input
        className="flex-1 border-none outline-none bg-transparent h-12 px-4 text-sm placeholder-gray-500"
        ref={inputRef}
        type="text"
        value={inputValue}
      ...
      <button
        ...
        className={`w-9 h-9 rounded-full flex items-center justify-center mr-2 transition-all duration-200 flex-shrink-0 ${
          isInputEmpty
